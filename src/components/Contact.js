  ...
  return (
    <div>
      <Flexrow>
          ...
          <Flexcolumn size={9}>
            <h3>I'm Jenny and during the COVID-19 pandemic, I learned to code part-time through the amazing course at Manchester Codes. Empowered by all the amazing things we can do with tech, I am more motivated than ever to join the sector and help contribute to change. This app is the final project of the 24 week course and I'm really keen to improve awareness of sustainable living and renewable energy to anyone who comes across it. Alongside coding,  I'm a keen reader, love the outdoors especially the Peak District, enjoying playing music and can't wait to get back to a museum. You can find me on <a href="https://twitter.com/niff_ellisiva">Twitter </a>and <a href="https://www.linkedin.com/in/jennifer-cant-09bb48120/">LinkedIn. </a></h3>
          </Flexcolumn>
      </Flexrow>
      <Flexrow>
          <Flexcolumn size={2}>
